...
iPad / Android + ゲームパッドで日本語・英語・韓国語・中国語簡体字・中国語繁體字・**Devanagari** を入力できる実験的アプリ。
...
- **6モード対応**: 日本語（かな漢字変換）・英語（T9 ベース）・韓国語（2ボル式ハングル合成）・中国語簡体字（abbreviated pinyin）・中国語繁體字（abbreviated zhuyin）・**Devanagari**（varnamala 時計回り）
...
Start ボタンでモードをサイクルする（日本語 → 韓国語 → 英語 → 中国語簡体 → 中国語繁體 → Devanagari → 日本語）。
...
### Devanagari モード（iOS / Android 両対応、Phase A9）
